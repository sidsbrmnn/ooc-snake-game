...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
	...
	public Gameplay() {
		titleImage = new ImageIcon(Gameplay.class.getResource("/assets/snaketitle.jpg"));
		upMouth = new ImageIcon(Gameplay.class.getResource("/assets/upmouth.png"));
		rightMouth = new ImageIcon(Gameplay.class.getResource("/assets/rightmouth.png"));
		downMouth = new ImageIcon(Gameplay.class.getResource("/assets/downmouth.png"));
		leftMouth = new ImageIcon(Gameplay.class.getResource("/assets/leftmouth.png"));
		snakeBody = new ImageIcon(Gameplay.class.getResource("/assets/snakeimage.png"));
		enemyImage = new ImageIcon(Gameplay.class.getResource("/assets/enemy.png"));
		xLength = new int[750];
		yLength = new int[750];
